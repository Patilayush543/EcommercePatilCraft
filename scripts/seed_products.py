...
products = [
    ...
    # Fashion (10 total)
    {'title': 'Relaxed Fit Raw Denim', 'brand': 'PatilApx', 'price': Decimal('69.99'), 'description': 'Sustainable raw finish denim — relaxed fit for everyday wear. Target: Male. Budget segment.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/relaxed_raw_denim/800/600', 'stock_count': 30},
    {'title': 'Technical Windbreaker', 'brand': 'PatilApx', 'price': Decimal('129.99'), 'description': 'Weather-proof activewear windbreaker with technical fabrics. Target: Male. Mid-Range.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/technical_windbreaker/800/600', 'stock_count': 18},
    {'title': 'Ribbed Knit Midi Skirt', 'brand': 'PatilApx', 'price': Decimal('39.99'), 'description': 'Essentials daily wear ribbed knit midi skirt. Target: Female. Budget segment.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/ribbed_midi_skirt/800/600', 'stock_count': 40},
    {'title': 'Leather Knee-High Boots', 'brand': 'PatilApx', 'price': Decimal('199.99'), 'description': 'Premium leather knee-high boots for elevated looks. Target: Female. Mid-Range.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/leather_knee_high_boots/800/600', 'stock_count': 10},
    {'title': 'Organic Cotton Play Suit', 'brand': 'PatilApx', 'price': Decimal('35.99'), 'description': 'Eco-friendly organic cotton playsuit for kids. Target: Kids. Budget segment.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/organic_play_suit/800/600', 'stock_count': 22},
    {'title': 'Reversible Puffer Vest', 'brand': 'PatilApx', 'price': Decimal('89.99'), 'description': 'Versatile reversible puffer vest for layering. Target: Kids. Mid-Range.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/reversible_puffer_vest/800/600', 'stock_count': 16},
    {'title': 'Performance Jogger', 'brand': 'PatilApx', 'price': Decimal('49.99'), 'description': 'Lightweight joggers with moisture-wicking fabric. Target: Male. Budget segment.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/performance_jogger/800/600', 'stock_count': 26},
    {'title': 'Seamless Sports Bra', 'brand': 'PatilApx', 'price': Decimal('29.99'), 'description': 'Comfort-first seamless sports bra for medium impact.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/seamless_sports_bra/800/600', 'stock_count': 34},
    {'title': 'Eco Linen Shirt', 'brand': 'PatilApx', 'price': Decimal('59.99'), 'description': 'Breathable eco-linen shirt for warm weather comfort.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/eco_linen_shirt/800/600', 'stock_count': 20},
    {'title': 'Convertible Travel Jacket', 'brand': 'PatilApx', 'price': Decimal('149.99'), 'description': 'Jacket converts to a packable travel pillow and tote.', 'category': 'fashion', 'image_url': 'https://picsum.photos/seed/convertible_travel_jacket/800/600', 'stock_count': 12},
]
